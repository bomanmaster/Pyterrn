...
class Toolbar(QtGui.QToolBar):
    ...
    def __init__(self, view):
        ...
        icon = QtGui.QIcon("img/tools/elipse.png")
        self.toggleViewAction().setIcon(icon)


    def toolbar_elipse(self):
...
class Drawing(QtGui.QGraphicsView):
    ...
    def drawing(self, start, end, color, width, style, color_brush, brush):
        ...
        self.elipse = QtGui.QGraphicsEllipseItem(QtCore.QRectF(start, end))
        self.elipse.setPen(QtGui.QPen(QtGui.QColor(str(color)), width, style))
        self.elipse.setBrush(QtGui.QBrush(QtGui.QColor(str(color_brush)), brush))
        command = Draw(self.scene, self.elipse)
        self.undoStack.push(command)


class Draw(QtGui.QUndoCommand):

    def __init__(self, scene, elipse):
    ...
    def redo(self):
        self.scene.addItem(self.elipse)
